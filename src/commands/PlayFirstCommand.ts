...
export class PlayFirstCommand extends BaseCommand {
    ...
    protected async run(bot: Bot, client: Client, context: CommandContext): Promise<void> {
        ...
        await this.#handleTracks(bot, client, context, player, res);
     ...
     * @private
     */
    async #handleTracks(bot: Bot, client: Client, context: CommandContext, player: Player, res: any): Promise<void> {
